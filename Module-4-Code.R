...
#   
#   Module 4 - Lesson: Create an R Markdown Template and Share It
# 
# R Code for R Script
...
table(weather_check$region)
table(steak_survey$region)

# Note that specific local RStudio cannot interactively run Knit with Parameters so converted to non-list version; error: 
# knit_with_parameters("C:/Users/Public/Documents/repos/rstudiogit/reproducible_WCtemplateSimple/wcArticle.Rmd")
# Error in yaml::yaml.load(yaml, handlers = knit_params_handlers(evaluate = evaluate),  : 
#     Scanner error: mapping values are not allowed in this context at line 9, column 10
